                    ...
                    <div className="w-full cursor-pointer text-justify  flex flex-col items-center gap-3 justify-center text-white">
                      ...
                      <section className="mb-2 mr-3">
                        ...
                        Agreement between User and {" "}
                          <a className="border-none" href="https://thecocreategroup.org">
                            thecocreategroup.org
                          </a>{" "}<br/>
                        </h2>
                        <p className="text-[12px] ">
                        
                          Welcome to thecocreategroup.org. The thecocreategroup.org
                          website (the "Site") is comprised of various web pages
                          operated by TrAIned OSAI ("TrAIned OSAI").
                          thecocreategroup.org is offered to you conditioned on
                          your acceptance without modification of the terms,
                          conditions, and notices contained herein (the
                          "Terms"). Your use of thecocreategroup.org constitutes
                          your agreement to all such Terms. Please read these
                          terms carefully, and keep a copy of them for your
                          reference. thecocreategroup.org is an Informational Site
                          providing information and contact details, sharing
                          news, offering elements for educational or other
                      ...
                      <section className="mb-2 mr-3">
                        <h2 className="text-[13px]">Children Under Thirteen</h2>
                        <p className="text-[12px]">
                          TrAIned OSAI does not knowingly collect, either online
                          or offline, personal information from persons under
                          the age of thirteen. If you are under 18, you may use
                          thecocreategroup.org only with the permission of a parent
                          or guardian.
                        </p>
                      </section>
                      <section className="mb-2 text-[12px] mr-3">
                        <h2  className="text-[13px]">Cancellation/Refund Policy</h2>
                        <p>
                          You may cancel your service or purchase at any time.
                          Any cancellations made after 60 days of service or use
                          will not qualify for a refund. Please contact us at{" "}
                          <a href="info@thecocreategroup.org">info@thecocreategroup.org</a>{" "}
                          with any questions.
                        </p>
                      </section>
                      <section className="mb-2 text-[12px] mr-3">
                        <h2  className="text-[13px]">Links to Third Party Sites/Third Party Services</h2>
                        <p>
                          <a href="https://thecocreategroup.org">
                            thecocreategroup.org
                          </a>{" "}
                          may contain links to other websites ("Linked Sites").
                          The Linked Sites are not under the control of TrAIned
                          OSAI, and TrAIned OSAI is not responsible for the
                          contents of any Linked Site, including without
                          limitation any link contained in a Linked Site, or any
                          changes or updates to a Linked Site. TrAIned OSAI is
                          providing these links to you only as a convenience,
                          and the inclusion of any link does not imply
                          endorsement by TrAIned OSAI of the site or any
                          ...
                          By using any product, service, or functionality
                          originating from the{" "}
                          <a href="https://thecocreategroup.org">
                            thecocreategroup.org
                          </a>{" "}
                          domain, you hereby acknowledge and consent that
                          TrAIned OSAI may share such information and data with
                          any third party with whom TrAIned OSAI has a
                      ...
                      <section className="mb-2 text-[12px] mr-3">
                        ...
                        <p>
                          ...
                          by TrAIned OSAI from our offices within the USA. If
                          you access the Service from a location outside the
                          USA, you are responsible for compliance with all local
                          laws. You agree that you will not use the Content
                          accessed through{" "}
                          <a href="https://thecocreategroup.org">
                            thecocreategroup.org
                          </a>
                      ...
                      <section className="mb-2 text-[12px] mr-3">
                        ...
                        <p>
                          ...
                          user postings made by you, your violation of any terms
                          of this Agreement or your violation of any rights of a
                          third party, or your violation of any applicable laws,
                          rules, or regulations. TrAIned OSAI reserves the
                          right, at its own cost, to assume the exclusive
                          defense and control of any matter otherwise subject to
                          indemnification by you, in which event you will fully
                          cooperate with TrAIned OSAI in asserting any available
                          defenses.
                        </p>
                      </section>
                      <section className="mb-2 text-[12px] mr-3">
                      ...
                      <section className="mb-2 text-[12px] mr-3">
                        ...
                        <p>
                          ...
                          you and TrAIned OSAI agree otherwise, the arbitrator
                      ...
                      <section className="mb-2 text-[12px] mr-3">
                        ...
                        <p>
                          ...
                          PERIODICALLY ADDED TO THE INFORMATION HEREIN. TrAIned
                          OSAI AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
                          CHANGES IN THE SITE AT ANY TIME. TrAIned OSAI AND/OR
                          ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
                          SUITABILITY, RELIABILITY, AVAILABILITY, TIMELINESS,
                          AND ACCURACY OF THE INFORMATION, SOFTWARE, PRODUCTS,
                          SERVICES, AND RELATED GRAPHICS CONTAINED ON THE SITE
                          FOR ANY PURPOSE. TO THE MAXIMUM EXTENT PERMITTED BY
                          ...
                          TrAIned OSAI AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL
                          WARRANTIES AND CONDITIONS WITH REGARD TO THIS
                          INFORMATION, SOFTWARE, PRODUCTS, SERVICES, AND RELATED
                          GRAPHICS, INCLUDING ALL IMPLIED WARRANTIES OR
                          CONDITIONS OF MERCHANTABILITY, FITNESS FOR A
                          PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. TO
                          THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO
                          EVENT SHALL TrAIned OSAI AND/OR ITS SUPPLIERS BE
                          ...
                          ANY WAY CONNECTED WITH THE USE OR PERFORMANCE OF THE
                          SITE, WITH THE DELAY OR INABILITY TO USE THE SITE OR
                          ...
                          TrAIned OSAI OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED
                          ...
                          TO YOU. IF YOU ARE DISSATISFIED WITH ANY PORTION OF
                          THE SITE OR WITH ANY OF THESE TERMS OF USE, YOUR SOLE
                          AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE SITE.
                        </p>
                      </section>
                      <section className="mb-2 text-[12px] mr-3">
                        <h2  className="text-[13px]">Termination/Access Restriction</h2>
                        <p>
                          ...
                          time, without notice. To the maximum extent permitted
                          by law, this agreement is governed by the laws of the
                          Commonwealth of Pennsylvania, and you hereby consent
                          to the exclusive jurisdiction and venue of courts in
                          Pennsylvania in all disputes arising out of or
                          ...
                          without limitation, this section. You agree that no
                          joint venture, partnership, employment, or agency
                          relationship exists between you and TrAIned OSAI as a
                          result of this agreement or use of the Site. TrAIned
                          OSAI's performance of this agreement is subject to
                          existing laws and legal process, and nothing contained
                          in this agreement is in derogation of TrAIned OSAI's
                          right to comply with governmental, court, and law
                          enforcement requests or requirements relating to your
                          use of the Site or information provided to or gathered
                          by TrAIned OSAI with respect to such use. If any part
                          ...
                          maintained in printed form. It is the express wish of
                          the parties that this agreement and all related
                          documents be written in English.
                        </p>
                      </section>
                      <section className="mb-3 text-[12px] mr-3">
                        Changes to Terms TrAIned OSAI reserves the right, in its
                        sole discretion, to change the Terms under which{" "}
                        <a href="https://thecocreategroup.org">thecocreategroup.org</a>{" "}is offered. The most current version
                        of the Terms will supersede all previous versions.
                        TrAIned OSAI encourages you to periodically review the
