  ...
  return (
    <>
      <div
        ...
        onClick={() => {}}
      >
        <h3 className="xl:text-[22px] text-[20px] pb-2">Privacy Policy</h3>
        ...
        <p className="xl:text-[16px] text-[14px] ">
          ...
          and TrAIned OSAI and governs data collection and usage. For the
          purposes of this Privacy Policy, unless otherwise noted, all
          references to TrAIned OSAI include{" "}
          <a
            href="https://thecocreategroup.org"
            className="border-none focus-visible:outline-none underline"
          >
          ...
          , TrAIned OSAI, and any of their subsidiaries. TrAIned OSAI's website
          is a personal informational site. By using TrAIned OSAI's website, you
          consent to the data practices described in this statement.
        </p>

        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">
          Collection of your Personal Information
        </h5>

        <p className="xl:text-[16px] text-[14px]">
          In order to better provide you with products and services offered,
          TrAIned OSAI may collect personally identifiable information, such as
          your:
          <ul className="xl:text-[16px] text-[14px]  list-disc p-2 pl-4">
        ...
        <p className="xl:text-[16px] text-[14px]">
          If you purchase TrAIned OSAI's products and services, we collect
          billing and credit card information. This information is used to
          complete the purchase transaction. TrAIned OSAI may also collect
          anonymous demographic information, which is not unique to you, such as
          your:
        </p>
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Use of your Personal Information</h5>

        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI collects and uses your personal information to operate
          and deliver the services you have requested. TrAIned OSAI may also use
          your personally identifiable information to inform you of other
          products or services available from TrAIned OSAI and its affiliates.
        </p>
        ...
        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI does not sell, rent, or lease its customer lists to third
          parties. TrAIned OSAI may, from time to time, contact you on behalf of
          ...
          to the third party. TrAIned OSAI may share data with trusted partners
          ...
          provide these services to TrAIned OSAI, and they are required to
          maintain the confidentiality of your information. TrAIned OSAI may
          disclose your personal information, without notice, if required to do
          so by law or in the good faith belief that such action is necessary
          to: (a) conform to the edicts of the law or comply with legal process
          served on TrAIned OSAI or the site; (b) protect and defend the rights
          or property of TrAIned OSAI; and/or (c) act under exigent
          circumstances to protect the personal safety of users of TrAIned OSAI,
          or the public.
        </p>
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Tracking User Behavior</h5>

        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI may keep track of the websites and pages our users visit
          within{" "}
          <a
            href="https://thecocreategroup.org"
            target="_blank"
          ...
          , in order to determine what services are the most popular. This data
        ...
        <p className="xl:text-[16px] text-[14px]">
          ...
          automatically collected by TrAIned OSAI. This information can include
          your IP address, browser type, domain names, access times, and
          referring website addresses. This information is used for the
          operation of the service, to maintain the quality of the service, and
          to provide general statistics regarding the use of the TrAIned OSAI
          website.
        </p>

        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Use of Cookies</h5>

        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI's website may use "cookies" to help you personalize your
          ...
          example, if you personalize TrAIned OSAI’s pages or register with
          TrAIned OSAI’s site or services, a cookie helps TrAIned OSAI to recall
          ...
          you can easily use the features that you customized. You have the
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Links</h5>
        ...
        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI secures your personal information from unauthorized
          access, use, or disclosure. TrAIned OSAI uses the following methods
          for this purpose:
        </p>
        ...
        <p className="xl:text-[16px] text-[14px]">
          ...
          encryption, such as the Secure Sockets Layer (SSL) protocol. We strive
          to take appropriate security measures to protect against unauthorized
          access to or alteration of your personal information. Unfortunately,
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Right to Deletion</h5>
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Children Under Thirteen</h5>

        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI does not knowingly collect personally identifiable
        ...
        <p className="xl:text-[16px] text-[14px]">
          ...
          TrAIned OSAI by contacting us here:
        </p>
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">E-mail Communications</h5>

        <p className="xl:text-[16px] text-[14px]">
          From time to time, TrAIned OSAI may contact you via email for the
          ...
          an email from TrAIned OSAI or click on a link therein. If you would
          like to stop receiving marketing or promotional communications via
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">External Data Storage Sites</h5>
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Changes to this Statement</h5>
        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI reserves the right to change this Privacy Policy from
        ...
        <h5 className="xl:text-[18px] text-[16px] pb-1 mt-2">Contact Information</h5>
        <p className="xl:text-[16px] text-[14px]">
          TrAIned OSAI welcomes your questions or comments regarding these Terms
          and Statement of Privacy. If you believe that TrAIned OSAI has not
          adhered to these Terms or this Statement, please contact us at:
        </p>
        <p className="xl:text-[16px] text-[14px]">
          Email Address:{" "}
          <a
